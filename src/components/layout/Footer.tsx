  ...
  return (
    <footer className="bg-gray-900 text-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="py-12 grid grid-cols-1 md:grid-cols-2  gap-8">
          ...
          >
            ...
            <p className="text-gray-300 mb-4 max-w-md">
              Fast, reliable and secure courier service for all your delivery
          ...
          <span className="grid grid-cols-1 sm:grid-cols-2 gap-8 md:gap-16">
        ...
        >
          <p>
            &copy; {currentYear} Somoy Express Courier. All rights reserved by
            @rrishiddh.
          </p>
        </motion.div>
      </div>
