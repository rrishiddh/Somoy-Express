...
export default function UpdateStatusForm({
  ...
  const statusOptions: {
  ...
  }[] = [
    {
      value: "requested",
      label: "Requested",
      description: "Parcel request has been submitted",
    },
    {
      value: "approved",
      label: "Approved",
      description: "Parcel request has been approved",
    },
    {
      value: "dispatched",
      label: "Dispatched",
      description: "Parcel has been dispatched from origin",
    },
    {
      value: "in-transit",
      label: "In Transit",
  ...
  const getCurrentStatus = () => {
    return statusOptions.find(
      (option) => option.value === parcel.currentStatus
    );
  };
          ...
          >
            ...
            <div className="text-sm text-yellow-800 space-y-1">
              ...
              <p className="mt-2 text-xs">
                This change will be logged and notification will be sent to both
                sender and receiver.
              </p>
            </div>
          </motion.div>
