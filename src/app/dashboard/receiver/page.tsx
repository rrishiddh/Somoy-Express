...
import { Package, CheckCircle, Clock, Eye, Search, Filter } from "lucide-react";
...
export default function ReceiverDashboard() {
  ...
  const {
    ...
    isLoading,
    refetch,
  } = useGetReceiverParcelsQuery(statusFilter || undefined);
  ...
  // console.log("parcels receiver", parcels);
  ...
  const canConfirmDelivery = (status: ParcelStatus) => {
                  ...
                  <div className="text-center py-12">
                    ...
                    <p className="text-gray-600">
                      {searchTerm || statusFilter
                        ...
                        : "You don't have any incoming parcels yet."}
                    </p>
                  </div>
                ) : (
                          ...
                          >
                            ...
                            <TableCell className="text-right">
                              <div className="flex justify-end gap-2">
                                ...
                                {canConfirmDelivery(parcel.currentStatus) && (
                                  <Button
                                    variant="ghost"
                                    size="sm"
                                    onClick={() =>
