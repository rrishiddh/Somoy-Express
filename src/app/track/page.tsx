        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <p className="text-xl text-blue-100 max-w-6xl mx-auto leading-relaxed">
              Enter your tracking ID below to get real-time updates on your package delivery status.
            </p>
          </motion.div>
        </div>
      </section>
              ...
              <Card className="shadow-lg">
                <CardHeader>
                  <div className="flex items-center justify-between">
                    ...
                    <Badge className={`px-4 py-2 text-sm font-medium ${getStatusColor(parcel.currentStatus)}`}>
                ...
                <CardContent className="space-y-6">
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div className="space-y-4">
                      <div>
                        <h4 className="font-medium text-gray-700 mb-1">Tracking ID</h4>
                        <p className="text-lg font-mono">{parcel.trackingId}</p>
                      </div>
                      <div>
                        <h4 className="font-medium text-gray-700 mb-1">Sender</h4>
                        <p>{parcel.sender.name}</p>
                        <p className="text-sm text-gray-600">{parcel.sender.email}</p>
                      </div>
                      <div>
                        <h4 className="font-medium text-gray-700 mb-1">From Address</h4>
                        <p className="text-sm">{parcel.senderAddress}</p>
                      </div>
                    </div>
                    <div className="space-y-4">
                      <div>
                        <h4 className="font-medium text-gray-700 mb-1">Package Type</h4>
                        <p className="capitalize">{parcel.parcelType}</p>
                      </div>
                      <div>
                        <h4 className="font-medium text-gray-700 mb-1">Receiver</h4>
                        <p>{parcel.receiver.name}</p>
                        <p className="text-sm text-gray-600">{parcel.receiver.email}</p>
                      </div>
                      <div>
                        <h4 className="font-medium text-gray-700 mb-1">To Address</h4>
                  ...
                  <div className="grid grid-cols-2 md:grid-cols-4 gap-4 pt-4 border-t">
                    <div className="text-center">
                      <p className="text-2xl font-bold text-blue-600">{parcel.weight}kg</p>
                      <p className="text-sm text-gray-600">Weight</p>
                    </div>
                    <div className="text-center">
                      <p className="text-2xl font-bold text-green-600">৳{parcel.fee}</p>
                      <p className="text-sm text-gray-600">Delivery Fee</p>
                    </div>
                    <div className="text-center">
                      <p className="text-2xl font-bold text-purple-600">{parcel.statusLogs.length}</p>
                      <p className="text-sm text-gray-600">Status Updates</p>
                    </div>
                    <div className="text-center">
                      <p className="text-2xl font-bold text-orange-600">
                        {Math.ceil((new Date().getTime() - new Date(parcel.createdAt).getTime()) / (1000 * 60 * 60 * 24))}
                      </p>
          ...
          {error && (
            ...
            >
              ...
              <p className="text-gray-600 mb-6">
                We couldn&apos;t find a package with that tracking ID. Please check the ID and try again.
              </p>
          ...
          >
            <Card className="bg-blue-50 border-blue-200">
              <CardContent className="p-8 text-center">
                ...
                <p className="text-gray-600 mb-6">
                  Can&apos;t find your package or having trouble with tracking? Our support team is here to help.
                </p>
